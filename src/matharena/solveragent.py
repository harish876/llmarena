...
"""
        ...
        _, out, cost = list(self.querier.run_queries([query], no_tqdm=True))[0]
        ...
        _, o, cost2 = list(self.querier.run_queries([query], no_tqdm=True))[0]
    ...
    def init_explorations(self, problem_statement, verbose=True, history=[]):
        ...
        _, output1, cost = list(self.querier.run_queries([query], no_tqdm=True))[0]
        ...
        _, solution, cost2 = list(self.querier.run_queries([query], no_tqdm=True))[0]
    ...
    def run(self):
        ...
        for index_iteration in range(self.max_iterations):
            ...
            if("yes" not in good_verify.lower()):
                ...
                _, solution, cost3 = list(self.querier.run_queries([query], no_tqdm=True))[0]
                solution = solution[-1]["content"]
                solution = self.remove_think(solution)
